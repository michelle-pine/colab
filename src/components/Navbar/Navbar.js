  ...
  render() {
    ...
    return (
      <nav className="navbar navbar-expand-lg">
        <Link className="navbar-brand" to="/?tag=none">CoLab</Link>
        ...
        <div className="collapse nav-link-group navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav ml-auto">
            <li className="nav-item">
              <NavLink activeClassName="active" isActive={this.isActive} className="nav-link" to="/?tag=none">All Projects</NavLink>
            </li>
            <li className="nav-item">
